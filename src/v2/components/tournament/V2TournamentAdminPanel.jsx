...
import TournamentModalitiesTab from '@/v2/components/tournament/V2TournamentModalitiesTab';
import TournamentRegistrationsTab from '@/v2/components/tournament/V2TournamentRegistrationsTab';
import TournamentDrawTab from '@/v2/components/tournament/V2TournamentDrawTab';
...
export default function TournamentAdminPanel({ tournament }) {
  return (
    <div className="space-y-5">
      <V2Surface className="arena-panel-strong overflow-hidden rounded-[2rem] border-0">
        <div className="relative p-6 sm:p-7 lg:p-8">
          ...
          <div className="relative max-w-3xl">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <V2Badge tone="neutral" className="rounded-full border-0 bg-amber-300 px-3 py-1 text-xs font-semibold text-amber-950 shadow-none">
                Somente admins
              </V2Badge>
            </div>
      ...
      <Tabs defaultValue="geral" className="w-full">
        ...
        <TabsContent value="resultados" className="mt-4">
          <V2TournamentMatches tournament={tournament} isAdmin />
        </TabsContent>
      </Tabs>
    </div>
  );
