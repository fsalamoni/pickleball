  ...
  return (
    <Card>
      <CardContent className="p-5 space-y-3">
        <h2 className="text-lg font-bold arena-heading flex items-center gap-2">
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-4 pb-10">
      <div className="space-y-1">
        <Link to="/inicio" className="text-sm text-emerald-700 inline-flex items-center gap-1 hover:underline">
          <ArrowLeft className="w-4 h-4" /> Voltar
        </Link>
        <h1 className="text-2xl font-bold arena-heading flex items-center gap-2">
          <BookOpen className="w-6 h-6 text-emerald-600" /> Guia de formatos e modelos de torneio
        </h1>
