    ...
    <div className="mx-auto max-w-5xl space-y-6">
        ...
        {arenasOn && (
          <Link to="/arenas" className="block">
            <Card className="rounded-[1.75rem] border-green-200 bg-gradient-to-br from-green-50 to-white">
              <CardContent className="flex items-center gap-3 p-4">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-ink text-white">
                  <Building2 className="h-5 w-5" />
                </div>
                <div className="min-w-0 flex-1">
                  <div className="font-semibold text-ink">Arenas parceiras</div>
                  <div className="text-sm text-gray-500">Encontre quadras, veja preços e horários e reserve sua partida.</div>
                </div>
                ...
                <Card className="h-full rounded-[1.75rem] border-white/80 bg-white/85">
                  <CardContent className="flex h-full flex-col p-5 sm:p-6">
                    {link.image_url ? (
                      ...
                      <div className="mb-3 flex h-28 w-full items-center justify-center rounded-lg bg-green-50 text-green-700">
