...
export const FLAG_GROUPS = Object.freeze([
  ...
  },
  {
    ...
    keys: [
      FEATURE_FLAG.NAV_USER_MENU, FEATURE_FLAG.MOBILE_BOTTOM_NAV, FEATURE_FLAG.NAV_HUBS,
      ...
      FEATURE_FLAG.NOTIFICATION_PREFS, FEATURE_FLAG.LEGAL_CENTER,
    ],
  },
  {
    id: 'athlete',
    ...
    keys: [
      ...
      FEATURE_FLAG.SKILL_RATING_DUPR, FEATURE_FLAG.DUPR_OFFICIAL_SYNC,
    ],
  },
  {
    id: 'tournaments',
    ...
    keys: [
      ...
      FEATURE_FLAG.TOURNAMENT_WIZARD, FEATURE_FLAG.TEAM_TOURNAMENTS,
  ...
  },
  {
    ...
    keys: [
      ...
      FEATURE_FLAG.ARENA_PRODUCT_CATALOG, FEATURE_FLAG.ARENA_MARKET_REPORTS,
    ],
  },
  {
    id: 'coaches',
    ...
    keys: [
      ...
      FEATURE_FLAG.COACH_LEVELING, FEATURE_FLAG.COACH_CLINICS,
