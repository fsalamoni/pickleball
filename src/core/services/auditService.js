...
export const AUDIT_ACTION_LABELS = {
  ...
  athlete_profiles_resynced: 'Diretório de atletas re-sincronizado em lote (admin)',
  ...
  dupr_matches_reopened: 'Partidas voltaram para pendente no DUPR (admin)',
  dupr_matches_excluded: 'Partidas marcadas para não lançar no DUPR (admin)',
  dupr_export_queue_removed: 'Partidas retiradas da lista de exportação DUPR (admin)',
  dupr_export_queue_restored: 'Partidas devolvidas à lista de exportação DUPR (admin)',
