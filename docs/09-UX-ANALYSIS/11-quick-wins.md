...
| QW-15 | Atualizar docs desatualizados | `01-AI-CONTEXT.md`/`README.md` citam `V1Routes.jsx` inexistente; rotas admin não documentadas | Revisar docs | — |
| QW-16 | `07-DESIGN-STANDARD.md` desalinhado | Manda `Platform*`/slate; código usa `V2*`/ink | Reescrever (DS-01) | — |
