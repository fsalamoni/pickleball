...
> **Status**: planejamento (sem código). Substitui qualquer documento anterior
> sobre o mesmo tema. Próxima ação: validar este plano, abrir issues e
> começar pela Sprint 0.
>
...
>
> **Estado atual no repositório (origin/main @ 9f14d2d)**:
> - 15 páginas V2Arena* no ar (sprints 1-7 completas, 8-11 em `V2ArenaAdvanced`)
> - 13 services + 1 hook monolítico `useArenaV3.js` (749 linhas)
> - 30 feature flags `ARENA_MODULE_*` (4-level gate)
> - 31 firestore collections + 5 Cloud Functions
> - `/admin/v3-bootstrap` (liga tudo de uma vez)
> - Domínio de booking/pricing **bem testado** (2 arquivos de teste)
> - **Zero testes** nos services novos (risco alto)
> - **0 das 20 melhorias UX do 07-arena.md estão implementadas**
